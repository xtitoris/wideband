...
#define HEATER_VOLTAGE_STAB_TIME 0.5f

#define HEATER_TEMP_STAB_TIME 0.5f

#define HEATER_DIDNOTHEAT_RETRY_TIMEOUT 30
#define HEATER_OVERHEAT_RETRY_TIMEOUT 60
#define HEATER_UNDERHEAT_RETRY_TIMEOUT 30

#define HEATER_UNDERVOLT_RETRY_TIMEOUT 1.0f
#define HEATER_OVERVOLT_RETRY_TIMEOUT 1.0f
