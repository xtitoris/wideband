...
void SendMotecAfrFormat(Configuration* configuration, uint8_t ch)
{
    ...
    frame->InternalTemp = GetMcuTemperature(); // temperature of the LTC unit, not the sensor temperature.
    frame->DutyCycle = GetHeaterDuty(ch) * 100;
